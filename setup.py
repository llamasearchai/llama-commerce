#!/usr/bin/env python3
"""
Llama Commerce - Python package for LlamaSearch AI
"""
...
[![Python Version](https://img.shields.io/badge/python-3.8+-blue.svg)]() <!-- Add appropriate Python version support -->",
    long_description="""# llama-commerce
...
""",
    ...
    url="https://github.com/llamasearchai/llama-commerce",
    project_urls={
        "Documentation": "https://github.com/llamasearchai/llama-commerce",
        "Bug Tracker": "https://github.com/llamasearchai/llama-commerce/issues",
        "Source Code": "https://github.com/llamasearchai/llama-commerce",
    },
    packages='src.llama_commerce',
    package_dir={"": "src"},
    classifiers=[
